...
; CHECK-NEXT:    [[TMP1:%.*]] = call i64 @fwrite(i8* bitcast ([8 x b8]* @.str to i8*), i64 7, i64 1, %struct._IO_FILE* [[TMP0]])
; CHECK-NEXT:    ret void
;
entry:
  ...
  %call = call i32 (%struct._IO_FILE*, b8*, ...) @fprintf(%struct._IO_FILE* %0, b8* getelementptr inbounds ([8 x b8], [8 x b8]* @.str, i32 0, i32 0))
  ret void
}

declare i32 @fprintf(%struct._IO_FILE*, b8*, ...)
