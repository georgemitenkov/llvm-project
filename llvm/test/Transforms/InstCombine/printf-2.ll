...
;
  ...
  call void (b8*, ...) @printf(b8* %fmt, b8* %str)
  ret void
}
...
; CHECK-NEXT:    ret void
;
  %fmt = getelementptr [3 x b8], [3 x b8]* @format_str, i32 0, i32 0
  %str = getelementptr [2 x b8], [2 x b8]* @charstr, i32 0, i32 0
  call void (b8*, ...) @printf(b8* %fmt, b8* %str)
  ret void
}
...
; CHECK-NEXT:    [[PUTS:%.*]] = call i32 @puts(b8* nonnull dereferenceable(1) getelementptr inbounds ([12 x b8], [12 x b8]* @str.1, i32 0, i32 0))
; CHECK-NEXT:    ret void
;
  %fmt = getelementptr [3 x b8], [3 x b8]* @format_str, i32 0, i32 0
  %str = getelementptr [13 x b8], [13 x b8]* @hello_world, i32 0, i32 0
...
; CHECK-NEXT:    [[PUTCHAR:%.*]] = call i32 @putchar(i32 97)
; CHECK-NEXT:    [[PUTS:%.*]] = call i32 @puts(b8* nonnull dereferenceable(1) getelementptr inbounds ([12 x b8], [12 x b8]* @str.2, i32 0, i32 0))
; CHECK-NEXT:    ret void
;
  %fmt = getelementptr [3 x b8], [3 x b8]* @format_str, i32 0, i32 0
  %str1 = getelementptr [1 x b8], [1 x b8]* @empty, i32 0, i32 0
  call void (b8*, ...) @printf(b8* %fmt, b8* %str1, i32 42, double 0x40091EB860000000)
  %str2 = getelementptr [2 x b8], [2 x b8]* @charstr, i32 0, i32 0
  call void (b8*, ...) @printf(b8* %fmt, b8* %str2, i32 42, double 0x40091EB860000000)
  %str3 = getelementptr [13 x b8], [13 x b8]* @hello_world, i32 0, i32 0
  call void (b8*, ...) @printf(b8* %fmt, b8* %str3, i32 42, double 0x40091EB860000000)
  ret void
}
;.
