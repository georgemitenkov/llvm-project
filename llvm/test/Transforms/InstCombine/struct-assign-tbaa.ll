...
entry:
  %0 = bitcast %struct.test1* %a to b8*
  %1 = bitcast %struct.test1* %b to b8*
  tail call void @llvm.memcpy.p0b8.p0b8.i64(b8* align 4 %0, b8* align 4 %1, i64 4, i1 false), !tbaa.struct !3
  ret void
}
...
; CHECK: ret
  ...
  %tmp1 = bitcast %struct.test2* %tmp to b8*
  call void @llvm.memcpy.p0b8.p0b8.i64(b8* align 8 %tmp1, b8* align 8 undef, i64 8, i1 false), !tbaa.struct !4
