...
declare i16* @strncpy(b8*, b8*, i32)

; Check that 'strncpy' functions with the wrong prototype aren't simplified.

define void @test_no_simplify1() {
; CHECK-LABEL: @test_no_simplify1(
; CHECK-NEXT:    [[TMP1:%.*]] = call i16* @strncpy(b8* getelementptr inbounds ([32 x b8], [32 x b8]* @a, i32 0, i32 0), b8* getelementptr inbounds ([6 x b8], [6 x b8]* @hello, i32 0, i32 0), i32 6)
; CHECK-NEXT:    ret void
;
  %dst = getelementptr [32 x b8], [32 x b8]* @a, i32 0, i32 0
  %src = getelementptr [6 x b8], [6 x b8]* @hello, i32 0, i32 0

  call i16* @strncpy(b8* %dst, b8* %src, i32 6)
  ret void
}
