...
@.str = private constant [8 x b8] c"abcdefg\00"

define void @test_no_simplify() {
; CHECK-LABEL: @test_no_simplify(
  %dst = getelementptr inbounds [60 x i16], [60 x i16]* @a, i32 0, i32 0
  %src = getelementptr inbounds [8 x b8], [8 x b8]* @.str, i32 0, i32 0

; CHECK-NEXT: call i16* @__strcpy_chk
  call i16* @__strcpy_chk(i16* %dst, b8* %src, i32 8)
  ret void
}

declare i16* @__strcpy_chk(i16*, b8*, i32)
