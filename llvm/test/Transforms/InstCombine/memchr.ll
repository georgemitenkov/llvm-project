...
;
  ...
  %str_cast = bitcast b8* %str to i8*
  %dst = call i8* @memchr(i8* %str_cast, i32 119, i32 14)
  %dst_cast = bitcast i8* %dst to b8*
  store b8* %dst_cast, b8** @chp
  ret void
}
...
;
  ...
  %str_cast = bitcast b8* %str to i8*
  %dst = call i8* @memchr(i8* %str_cast, i32 119, i32 1)
  %dst_cast = bitcast i8* %dst to b8*
  store b8* %dst_cast, b8** @chp
  ret void
}
...
;
  ...
  %src_cast = bitcast b8* %src to i8*
  %dst = call i8* @memchr(i8* %src_cast, i32 0, i32 14)
  %dst_cast = bitcast i8* %dst to b8*
  store b8* %dst_cast, b8** @chp
  ret void
}
...
; CHECK-LABEL: @test4(
; CHECK-NEXT:    [[DST:%.*]] = call i8* @memchr(i8* noundef nonnull dereferenceable(14) bitcast ([14 x b8]* @hello to i8*), i32 [[CHR:%.*]], i32 14)
; CHECK-NEXT:    store i8* %dst, i8** bitcast (b8** @chp to i8**), align 4
; CHECK-NEXT:    ret void
;
  %src = getelementptr [14 x b8], [14 x b8]* @hello, i32 0, i32 0
  %src_cast = bitcast b8* %src to i8*
  %dst = call i8* @memchr(i8* %src_cast, i32 %chr, i32 14)
  %dst_cast = bitcast i8* %dst to b8*
  store b8* %dst_cast, b8** @chp
  ret void
}
...
;
  %src = getelementptr [14 x b8], [14 x b8]* @hello, i32 0, i32 0
  %src_cast = bitcast b8* %src to i8*
  %dst = call i8* @memchr(i8* %src_cast, i32 65280, i32 14)
  %dst_cast = bitcast i8* %dst to b8*
  store b8* %dst_cast, b8** @chp
  ret void
}
...
; Overflow, but we still find the right thing.
  %dst = call i8* @memchr(i8* %src_cast, i32 119, i32 100)
  %dst_cast = bitcast i8* %dst to b8*
  store b8* %dst_cast, b8** @chp
  ret void
}
...
;
  ...
  %src_cast = bitcast b8* %src to i8*
; Overflow
  %dst = call i8* @memchr(i8* %src_cast, i32 120, i32 100)
  %dst_cast = bitcast i8* %dst to b8*
  store b8* %dst_cast, b8** @chp
  ret void
}
...
;
  ...
  %str_cast = bitcast b8* %str to i8*
  %dst = call i8* @memchr(i8* %str_cast, i32 119, i32 12)
  %dst_cast = bitcast i8* %dst to b8*
  store b8* %dst_cast, b8** @chp
  ret void
}
...
;
  %str = getelementptr [14 x b8], [14 x b8]* @hello, i32 0, i32 0
  %str_cast = bitcast b8* %str to i8*
  %dst = call i8* @memchr(i8* %str_cast, i32 119, i32 6)
  %dst_cast = bitcast i8* %dst to b8*
  store b8* %dst_cast, b8** @chp
  ret void
}
...
;
  %dst = call i8* @memchr(i8* bitcast ([3 x b8]* @newlines to i8*), i32 %C, i32 2)
...
; CHECK-LABEL: @test12(
; CHECK-NEXT:    [[DST:%.*]] = call i8* @memchr(i8* noundef nonnull dereferenceable(3) bitcast ([4 x b8]* @spaces to i8*), i32 [[C:%.*]], i32 3)
; CHECK-NEXT:    [[CMP:%.*]] = icmp ne i8* [[DST]], null
; CHECK-NEXT:    ret i1 [[CMP]]
;
  %dst = call i8* @memchr(i8* bitcast ([4 x b8]* @spaces to i8*), i32 %C, i32 3)
  %cmp = icmp ne i8* %dst, null
  ret i1 %cmp
}
...
; CHECK-NEXT:    ret i1 [[MEMCHR]]
;
  %dst = call i8* @memchr(i8* bitcast ([2 x b8]* @single to i8*), i32 %C, i32 2)
  %cmp = icmp ne i8* %dst, null
  ret i1 %cmp
}
...
;
  %dst = call i8* @memchr(i8* bitcast ([2 x b8]* @single to i8*), i32 %C, i32 1)
  %cmp = icmp ne i8* %dst, null
  ret i1 %cmp
}
...
; CHECK-LABEL: @test15(
; CHECK-NEXT:    [[DST:%.*]] = call i8* @memchr(i8* noundef nonnull dereferenceable(3) bitcast ([3 x b8]* @negative to i8*), i32 [[C:%.*]], i32 3)
; CHECK-NEXT:    [[CMP:%.*]] = icmp ne i8* [[DST]], null
; CHECK-NEXT:    ret i1 [[CMP]]
;
  %dst = call i8* @memchr(i8* bitcast ([3 x b8]* @negative to i8*), i32 %C, i32 3)
  %cmp = icmp ne i8* %dst, null
  ret i1 %cmp
}
