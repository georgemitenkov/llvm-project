...
; CHECK-NEXT:    [[RET:%.*]] = call i32 @puts(b8* noundef nonnull dereferenceable(1) getelementptr inbounds ([1 x b8], [1 x b8]* @empty, i32 0, i32 0))
; CHECK-NEXT:    ret i32 [[RET]]
;
  %str = getelementptr [1 x b8], [1 x b8]* @empty, i32 0, i32 0
  %ret = call i32 @puts(b8* %str)
  ret i32 %ret
}
