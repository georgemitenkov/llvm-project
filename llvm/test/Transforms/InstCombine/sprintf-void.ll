...
; CHECK-NEXT:    call void (b8*, b8*, ...) @sprintf(b8* [[DST:%.*]], b8* getelementptr inbounds ([13 x b8], [13 x b8]* @hello_world, i32 0, i32 0))
; CHECK-NEXT:    ret void
;
  %fmt = getelementptr [13 x b8], [13 x b8]* @hello_world, i32 0, i32 0
  call void (b8*, b8*, ...) @sprintf(b8* %dst, b8* %fmt)
  ret void
}
