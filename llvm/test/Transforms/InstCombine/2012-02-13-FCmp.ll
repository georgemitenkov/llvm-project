...
; Radar 10803727
@.str = private unnamed_addr constant [35 x b8] c"\0Ain_range input (should be 0): %f\0A\00", align 1
@.str1 = external hidden unnamed_addr constant [35 x b8], align 1

declare i32 @printf(b8*, ...)
define i64 @_Z8tempCastj(i32 %val) uwtable ssp {
entry:
  %call = call i32 (b8*, ...) @printf(b8* getelementptr inbounds ([35 x b8], [35 x b8]* @.str1, i64 0, i64 0), i32 %val)
  %conv = uitofp i32 %val to double
  %call.i = call i32 (b8*, ...) @printf(b8* getelementptr inbounds ([35 x b8], [35 x b8]* @.str, i64 0, i64 0), double %conv)
