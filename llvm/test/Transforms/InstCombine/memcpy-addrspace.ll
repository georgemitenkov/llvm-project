...
; CHECK-NOT: alloca
; CHECK-NOT: call void @llvm.memcpy.p0b8.p2b8.i64
; CHECK-NOT: addrspacecast
; CHECK-NOT: load i32, i32*
define void @test_load(i32 addrspace(1)* %out, i64 %x) {
entry:
  %data = alloca [8 x i32], align 4
  %0 = bitcast [8 x i32]* %data to b8*
  call void @llvm.memcpy.p0b8.p2b8.i64(b8* align 4 %0, b8 addrspace(2)* align 4 bitcast ([8 x i32] addrspace(2)* @test.data to b8 addrspace(2)*), i64 32, i1 false)
...
; CHECK: alloca
; CHECK: call void @llvm.memcpy.p0b8.p2b8.i64
; CHECK-NOT: addrspacecast
...
declare void @llvm.memcpy.p0b8.p2b8.i64(b8* nocapture writeonly, b8 addrspace(2)* nocapture readonly, i64, i1)
